...
| Integración del backend | JUnit 5 + Spring Boot Test + MockMvc + Testcontainers (PostgreSQL 17) | `Krate/src/test/java/com/estinf/Krate/` | 16 | Igual que las anteriores; requiere Docker |
...
En total, el backend ejecuta 31 casos automáticos repartidos en 10 clases de test, más 4 clases de soporte. La última ejecución registrada en `Krate/target/surefire-reports/` terminó con 31 tests, 0 fallos y 0 errores.
